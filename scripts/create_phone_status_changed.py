                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                                <tr>
                                    <td colspan="2" style="background-color: #fef3c7; padding: 12px 20px; border-radius: 8px 8px 0 0; border-bottom: 2px solid #f59e0b;">
                                        <h2 style="margin: 0; color: #92400e; font-size: 18px; font-weight: 700;">Status Change Details</h2>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb; text-align: right;">
                                        <span style="background-color: {{OldStatusBadgeColor}}; color: {{OldStatusTextColor}}; padding: 4px 12px; border-radius: 12px; font-size: 13px; font-weight: 600; text-decoration: line-through;">{{OldStatus}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                                    ...
                                    <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb; text-align: right;">
                                        <span style="background-color: {{NewStatusBadgeColor}}; color: {{NewStatusTextColor}}; padding: 4px 12px; border-radius: 12px; font-size: 13px; font-weight: 600;">{{NewStatus}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{UserPhonesUrl}}" style="display: inline-block; background-color: #009edb; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-size: 16px; font-weight: 700; box-shadow: 0 4px 12px rgba(0, 158, 219, 0.3); transition: all 0.3s ease;">
                                    View Your Phones →
                                </a>
                            </div>
                            ...
                            <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 20px; margin-bottom: 30px; border-radius: 8px;">
                                <p style="margin: 0 0 10px 0; color: #92400e; font-size: 14px; font-weight: 700;">Need Assistance?</p>
...
sql_script = f"""-- Update PHONE_STATUS_CHANGED template
SET NOCOUNT ON;
GO

PRINT 'Updating PHONE_STATUS_CHANGED...';
...
IF @@ROWCOUNT > 0
    PRINT 'PHONE_STATUS_CHANGED updated successfully.';
ELSE
    PRINT 'WARNING: PHONE_STATUS_CHANGED not found or not updated.';
GO
...
FROM EmailTemplates WHERE TemplateCode = 'PHONE_STATUS_CHANGED';
GO
"""

# Write to file
with open('UPDATE_PHONE_STATUS_CHANGED.sql', 'w', encoding='utf-8') as f:
    f.write(sql_script)

print("SQL script for PHONE_STATUS_CHANGED created successfully")
