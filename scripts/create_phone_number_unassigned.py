...
sql_script = f"""-- Update PHONE_NUMBER_UNASSIGNED template
SET NOCOUNT ON;
GO
...
# Write to file
with open('UPDATE_PHONE_NUMBER_UNASSIGNED.sql', 'w', encoding='utf-8') as f:
    f.write(sql_script)

print("SQL script for PHONE_NUMBER_UNASSIGNED created successfully")
