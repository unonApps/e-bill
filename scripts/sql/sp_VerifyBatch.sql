-- Stored procedure to verify all pending records in a batch
-- This is much faster than updating records one by one through EF Core

CREATE OR ALTER PROCEDURE sp_VerifyBatch
