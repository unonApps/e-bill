...
{
    /// <inheritdoc />
    public partial class FixPushToProductionProcessingStatusValue : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Fix: The original stored procedure used ProcessingStatus = 3 (Failed) instead of 2 (Completed)
            // ProcessingStatus enum values: 0=Staged, 1=Processing, 2=Completed, 3=Failed, 4=Verified

            migrationBuilder.Sql(@"
                -- Drop and recreate sp_PushBatchToProduction with correct ProcessingStatus values
            ...
            // Also fix any existing records that were incorrectly set to Failed (3) when they should be Completed (2)
            migrationBuilder.Sql(@"
