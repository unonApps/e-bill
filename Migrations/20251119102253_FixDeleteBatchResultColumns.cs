...
{
    /// <inheritdoc />
    public partial class FixDeleteBatchResultColumns : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop and recreate sp_DeleteBatch to return consistent columns
            // Both success and error results must include all columns expected by DeleteBatchResult
