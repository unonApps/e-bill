...
{
    /// <inheritdoc />
    public partial class AddCallLogVerificationSystemTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyCallCostLimit = table.Column<decimal>(type: "decimal(18,4)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpAddress = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SimRequestId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupervisorIndexNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SupervisorAction = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    SupervisorActionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
