...
{
    /// <inheritdoc />
    public partial class UpdateConsolidateStoredProcWithIsAdjustment : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop the old stored procedure that's missing IsAdjustment column
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS sp_ConsolidateCallLogBatch");

            // Recreate with IsAdjustment included in all INSERT statements
...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO CallLogStagings (
            ...
            VerificationStatus, ProcessingStatus, IsAdjustment, CreatedDate
        )
        SELECT
...
END");
        ...
        {
            // Revert to old version without IsAdjustment (not recommended)
            migrationBuilder.Sql("DROP PROCEDURE IF EXISTS sp_ConsolidateCallLogBatch");
        }
    }
}
