...
namespace TAB.Web.Migrations
{
    ...
    [Migration("20260305055025_AddDialedNumbersAndCallLogsStoredProcedures")]
    partial class AddDialedNumbersAndCallLogsStoredProcedures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    ...
                    b.ToTable("AspNetRoleClaims", "ebill");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    ...
                    b.ToTable("AspNetUserClaims", "ebill");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserLogin<string>", b =>
                {
                    ...
                    b.ToTable("AspNetUserLogins", "ebill");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.ToTable("AspNetUserRoles", "ebill");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserToken<string>", b =>
                {
                    ...
                    b.ToTable("AspNetUserTokens", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("EbillUserId")
                        .IsUnique()
                        .HasFilter("[EbillUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("TAB.Web.Models.BillingPeriod", b =>
                {
                    ...
                    b.ToTable("BillingPeriods", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.CallLogDocument", b =>
                {
                    ...
                    b.ToTable("CallLogDocuments", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.CallLogPaymentAssignment", b =>
                {
                    ...
                    b.HasIndex("AssignedFrom", "AssignmentStatus", "CallRecordId");

                    b.HasIndex("AssignedTo", "AssignmentStatus", "CallRecordId");

                    b.ToTable("CallLogPaymentAssignments", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.CallLogReconciliation", b =>
                {
                    ...
                    b.ToTable("CallLogReconciliations", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.CallLogStaging", b =>
                {
                    ...
                    b.ToTable("CallLogStagings", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.CallLogVerification", b =>
                {
                    ...
                    b.HasIndex("SubmittedToSupervisor", "CallRecordId", "ApprovalStatus");

                    b.ToTable("CallLogVerifications", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.CallRecord", b =>
                {
                    ...
                    b.Property<int?>("SnapshotOfficeId")
                        .HasColumnType("int")
                        .HasColumnName("snapshot_office_id");

                    b.Property<string>("SnapshotOfficeName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("snapshot_office_name");

                    b.Property<int?>("SnapshotOrganizationId")
                        .HasColumnType("int")
                        .HasColumnName("snapshot_org_id");

                    b.Property<string>("SnapshotOrganizationName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("snapshot_org_name");

                    b.Property<int?>("SnapshotSubOfficeId")
                        .HasColumnType("int")
                        .HasColumnName("snapshot_suboffice_id");

                    b.Property<string>("SnapshotSubOfficeName")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("snapshot_suboffice_name");
            ...
            modelBuilder.Entity("TAB.Web.Models.ClassOfService", b =>
                {
                    ...
                    b.ToTable("ClassOfServices", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.DeadlineTracking", b =>
                {
                    ...
                    b.ToTable("DeadlineTracking", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.EbillUser", b =>
                {
                    ...
                    b.Property<bool>("HasLoginAccount")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TAB.Web.Models.EmailAttachment", b =>
                {
                    ...
                    b.ToTable("EmailAttachments", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.EmailConfiguration", b =>
                {
                    ...
                    b.ToTable("EmailConfigurations", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.EmailTemplate", b =>
                {
                    ...
                    b.ToTable("EmailTemplates", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.InterimUpdate", b =>
                {
                    ...
                    b.ToTable("InterimUpdates", "ebill");
                });

            modelBuilder.Entity("TAB.Web.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TAB.Web.Models.Organization", b =>
                {
                    ...
                    b.Property<bool>("SkipVerificationWithinCOS")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TAB.Web.Models.PhoneOverageDocument", b =>
                {
                    ...
                    b.ToTable("PhoneOverageDocuments", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.PhoneOverageJustification", b =>
                {
                    ...
                    b.ToTable("PhoneOverageJustifications", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.RecoveryConfiguration", b =>
                {
                    ...
                    b.ToTable("RecoveryConfiguration", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.RecoveryJobExecution", b =>
                {
                    ...
                    b.ToTable("RecoveryJobExecutions", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.RecoveryLog", b =>
                {
                    ...
                    b.HasIndex("RecoveryAction");

                    b.HasIndex("RecoveryDate");

                    b.HasIndex("RecoveryType");

                    b.HasIndex("RecoveryDate", "RecoveryAction");

                    b.HasIndex("RecoveryDate", "RecoveryType");

                    b.ToTable("RecoveryLogs", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.RefundRequest", b =>
                {
                    ...
                    b.ToTable("RefundRequests", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.RefundRequestHistory", b =>
                {
                    ...
                    b.ToTable("RefundRequestHistories", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.ServiceProvider", b =>
                {
                    ...
                    b.ToTable("ServiceProviders", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.SimRequestHistory", b =>
                {
                    ...
                    b.ToTable("SimRequestHistories", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.StagingBatch", b =>
                {
                    ...
                    b.ToTable("StagingBatches", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.UserPhoneHistory", b =>
                {
                    ...
                    b.ToTable("UserPhoneHistories", "ebill");
                });
            ...
            modelBuilder.Entity("TAB.Web.Models.ApplicationUser", b =>
                {
                    b.HasOne("TAB.Web.Models.EbillUser", "EbillUser")
                        ...
                        .HasForeignKey("TAB.Web.Models.ApplicationUser", "EbillUserId")
            ...
            modelBuilder.Entity("TAB.Web.Models.CallLogVerification", b =>
                {
                    ...
                    b.HasOne("TAB.Web.Models.CallLogPaymentAssignment", "PaymentAssignment")
                        .WithMany()
                        .HasForeignKey("PaymentAssignmentId");
            ...
            modelBuilder.Entity("TAB.Web.Models.Notification", b =>
                {
                    b.HasOne("TAB.Web.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
