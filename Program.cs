...
// Add Hangfire for background job processing with SQL Server storage
// Using ebill schema to match database permissions
builder.Services.AddHangfire(config => config
    ...
    {
        SchemaName = "ebill",  // Use ebill schema instead of dbo
...
{
    // Temporarily show detailed errors for debugging Azure deployment
