    ...
    public class MyCallLogsModel : PageModel
    {
        ...
        private async Task LoadCallRecordsAsync()
        {
            ...
            var query = _context.CallRecords
                ...
                .Where(c => c.CallDate.Year > 1) // Filter out invalid dates but keep subscription/data plan records
                .AsQueryable();
            ...
            try
            {
                ...
                var query = _context.CallRecords
                    .Where(c => c.ExtensionNumber == extension
                           && c.CallMonth == month
                           && c.CallYear == year
                           && (c.CallDate.Year > 1) // Filter out invalid dates but keep subscription/data plan records
