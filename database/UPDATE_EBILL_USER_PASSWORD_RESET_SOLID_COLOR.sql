-- Update EBILL_USER_PASSWORD_RESET template with solid colors (no gradients)
SET NOCOUNT ON;
GO
...
',
    ...
    ModifiedBy = 'System'
WHERE TemplateCode = 'EBILL_USER_PASSWORD_RESET';
GO

PRINT 'EBILL_USER_PASSWORD_RESET updated with solid colors!';
GO
