-- =============================================
-- Update USER_PASSWORD_RESET Template with Inline Logo Image
-- Uses cid: reference for embedded logo attachment
-- =============================================

SET NOCOUNT ON;
GO

PRINT 'Updating USER_PASSWORD_RESET template with inline logo image...';
GO
...
IF @@ROWCOUNT > 0
BEGIN
    PRINT 'USER_PASSWORD_RESET template updated successfully with inline logo image!';
    PRINT 'The template now uses cid:logo to reference the embedded logo attachment.';
    PRINT 'Logo will be attached automatically and display in all email clients!';
