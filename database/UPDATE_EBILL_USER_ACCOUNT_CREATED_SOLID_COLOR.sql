-- Update EBILL_USER_ACCOUNT_CREATED template with solid colors
SET NOCOUNT ON;
GO
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{LoginUrl}}" style="display: inline-block; background-color: #009edb; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-size: 16px; font-weight: 700; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3); transition: all 0.3s ease;">
                                    Login to E-Billing →
                                </a>
                            </div>
...
PRINT 'EBILL_USER_ACCOUNT_CREATED updated with solid colors!';
GO
