-- =============================================
-- Update USER_PASSWORD_RESET Template with Logo
-- Replaces the text header with UNON E-Billing logo
-- =============================================

SET NOCOUNT ON;
GO

PRINT 'Updating USER_PASSWORD_RESET template with logo...';
GO
...
SET
    ...
    '                            <img src="{{BaseUrl}}/images/ebilling-login.jpg"'+
    ...
    '</body>'+
    '</html>',
    AvailablePlaceholders = '{{FirstName}}, {{LastName}}, {{Email}}, {{NewPassword}}, {{ResetDate}}, {{BaseUrl}}, {{LoginUrl}}',
...
IF @@ROWCOUNT > 0
BEGIN
    PRINT 'USER_PASSWORD_RESET template updated successfully with logo!';
