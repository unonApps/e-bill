-- =============================================
-- E-Bill User Management Email Templates
-- Insert email templates for Ebill user account creation and password reset
-- =============================================
...
DELETE FROM EmailTemplates WHERE TemplateCode IN ('EBILL_USER_ACCOUNT_CREATED', 'EBILL_USER_PASSWORD_RESET');
GO

-- =============================================
-- 1. EBILL USER ACCOUNT CREATED TEMPLATE
-- =============================================
...
VALUES (
    'E-Bill User Account Created',
    'EBILL_USER_ACCOUNT_CREATED',
    'Welcome to UNON E-Billing - Your Login Account Has Been Created',
    '<!DOCTYPE html>'+
    '<html lang="en">'+
    '<head>'+
    '    <meta charset="UTF-8">'+
    ...
    '</html>'
,
    'Email template sent to Ebill users when their login account is created. Includes login credentials and instructions for first-time login.',
    '{{FirstName}}, {{LastName}}, {{Email}}, {{TempPassword}}, {{IndexNumber}}, {{LoginUrl}}',
    'E-Bill User Management',
    1,
    1,
    GETUTCDATE()
);
...
-- =============================================
-- 2. EBILL USER PASSWORD RESET TEMPLATE
-- =============================================
INSERT INTO EmailTemplates (
    Name,
    TemplateCode,
...
VALUES (
    ...
    '                                Your E-Billing Password Has Been Reset'+
    '                            </p>'+
    '                        </td>'+
    '                    </tr>'+
    ''+
    ...
    ''+
    '                            <p style="margin: 0 0 30px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">'+
    '                                Your password for the UNON E-Billing System has been reset. Below are your new login credentials:'+
    '                            </p>'+
    ''+
    '                            <!-- Account Details Section -->'+
    '                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">'+
    ...
    '</html>'
,
    'Email template sent to Ebill users when their password is reset. Includes new temporary password and security instructions.',
    '{{FirstName}}, {{LastName}}, {{Email}}, {{TempPassword}}, {{IndexNumber}}, {{ResetDate}}, {{LoginUrl}}',
    'E-Bill User Management',
    1,
    1,
    GETUTCDATE()
...
PRINT 'E-Bill User Management email templates inserted successfully.';
GO
