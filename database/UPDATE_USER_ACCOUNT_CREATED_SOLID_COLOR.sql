-- Update USER_ACCOUNT_CREATED template with solid colors
SET NOCOUNT ON;
GO
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <div style="text-align: center; margin: 30px 0;">
                                <a href="{{LoginUrl}}" style="display: inline-block; background-color: #009edb; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-size: 16px; font-weight: 700; box-shadow: 0 4px 12px rgba(0, 158, 219, 0.3); transition: all 0.3s ease;">
...
',
    ...
    ModifiedBy = 'System'
WHERE TemplateCode = 'USER_ACCOUNT_CREATED';
GO

PRINT 'USER_ACCOUNT_CREATED updated with solid colors!';
GO
