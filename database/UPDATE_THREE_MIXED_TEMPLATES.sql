-- Standardize 3 mixed templates (1 REFUND + 2 PHONE) with inline logo, solid colors, no emojis
SET NOCOUNT ON;
GO

-- 1. Update REFUND_REQUEST_SUBMITTED
PRINT 'Updating REFUND_REQUEST_SUBMITTED...';
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 30px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                                Your device reimbursement request has been <strong>successfully submitted</strong> and is now under review.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px;">
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb; text-align: right;">
                                        <span style="color: #1f2937; font-size: 14px; font-weight: 600;">{{RequestDate}}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px 20px; border-bottom: 1px solid #e5e7eb;">
                            ...
                            <div style="background-color: #dbeafe; border-left: 4px solid #3b82f6; padding: 20px; margin-bottom: 30px; border-radius: 8px;">
                                ...
                                <p style="margin: 0; color: #1e40af; font-size: 14px; line-height: 1.6;">
                                    Your supervisor will review your request. You will receive an email notification once a decision has been made.
                                </p>
                            </div>
...
WHERE TemplateCode = 'REFUND_REQUEST_SUBMITTED';

IF @@ROWCOUNT > 0
    PRINT 'REFUND_REQUEST_SUBMITTED updated successfully.';
ELSE
    PRINT 'WARNING: REFUND_REQUEST_SUBMITTED not found or not updated.';
GO
SQLEOF
